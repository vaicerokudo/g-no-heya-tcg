...
const mapStyle: CSSProperties = { position: "relative", width: "min(calc(100vw - 16px), 1420px)", minHeight: "min(86dvh, 960px)", marginLeft: "50%", transform: "translateX(-50%)", overflow: "hidden", borderRadius: 14, border: "1px solid rgba(210,232,255,0.22)", background: "linear-gradient(180deg, rgba(8, 12, 18, 0.02), rgba(4, 7, 11, 0.24)), url('/backgrounds/necro-city-map.webp') center / cover no-repeat, linear-gradient(145deg, #28313a 0%, #161a20 52%, #0d1016 100%)", boxShadow: "0 20px 56px rgba(0,0,0,0.5), inset 0 0 54px rgba(0,0,0,0.28)" };
const mapNarrowStyle: CSSProperties = { width: "100%", minHeight: "72dvh", marginLeft: 0, transform: "none", borderRadius: 12 };
