...
export const SCENARIOS: Partial<Record<ScenarioId, ScenarioConfig>> = {
  ...
  scenario_hidden_author: {
    ...
    placements: [
      { unitId: "TSUTSU", side: "south", r: 7, c: 0, instanceId: "SCA-TSUTSU" },
      { unitId: "ROKUDO", side: "south", r: 7, c: 1, instanceId: "SCA-ROKUDO" },
      { unitId: "SOCHO", side: "south", r: 7, c: 2, instanceId: "SCA-SOCHO" },
      { unitId: "MYOUOU", side: "south", r: 7, c: 3, instanceId: "SCA-MYOUOU" },
      { unitId: "7171", side: "south", r: 7, c: 4, instanceId: "SCA-7171" },
      { unitId: "HIBIKI", side: "south", r: 7, c: 5, instanceId: "SCA-HIBIKI" },
      { unitId: "USHIMARU", side: "south", r: 7, c: 6, instanceId: "SCA-USHIMARU" },
      ...
      { unitId: "ROKUDO_AUTHOR", side: "north", r: 2, c: 4, instanceId: "SCA-ROKUDO-AUTHOR", hp: 45 },
    ],
    dialogs: {
      intro: [
